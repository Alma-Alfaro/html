<?php
    require('encabezadoUsuario.php');
    require('conexionBD.php');
  
    if(isset($_POST['enviarRegistro'])){
      $nombre=$_POST['nombre'];
      $compania=$_POST['companyname'];
      $email=$_POST['myemail'];
      $comentario=$_POST['mycomments'];
  
      $verificacion = "SELECT nombre, email FROM asistentesregistro";
      ...
      if(!$bandera){
        ...
        $consulta = "INSERT INTO asistentesregistro VALUES(null,'$nombre','$compania', '$email','$comentario')";
    ...
    <article id="registrationform">
      <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
        <fieldset>
          ...
          <input type="submit" value="Send" name="enviarRegistro">
        </fieldset>
      </form>
    </article>
  </section>
